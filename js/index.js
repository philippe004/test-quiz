// la variable historique ressemblera a ca:
// [
    // {
        // date: `la date en js`,
        // reponse: [ 2,0,3,1,0]
...
function verifierReponse(event) {
    ...
    // historique.
    historique[historique.length-1].Response.push(event.target.indexChoix);
...
function afficherFinQuiz() {
    ...
    for (let partie of historique) {
        zoneFinQuiz.innerHTML += `<p>Date : ${partie.date} / reponse : ${partie.reponse}<p>`;
